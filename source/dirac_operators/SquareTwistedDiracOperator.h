#ifndef SQUARETWISTEDDIRACOPERATOR_H_
#define SQUARETWISTEDDIRACOPERATOR_H_

#include "DiracOperator.h"

namespace Update {

class SquareTwistedDiracOperator : public Update::DiracOperator {
public:
	SquareTwistedDiracOperator();
	SquareTwistedDiracOperator(const extended_fermion_lattice_t& _lattice, real_t _kappa = 0., bool _gamma5 = true);
	~SquareTwistedDiracOperator();
