OBJECTS  = ReducedStencil.o StandardStencil.o ExtendedStencil.o LocalLayout.o \
			...
			ReUnit.o StoutSmearing.o Gamma.o RandomGaugeTransformation.o \
			RandomSeed.o \
			...
			StochasticEstimator.o MesonCorrelator.o ChiralCondensate.o SingletOperators.o GluinoGlue.o NPRVertex.o XSpaceCorrelators.o OverlapChiralRotation.o \
